...
let first = new Product(1, 10000,'MacBook Pro 11', "Laptop.jpeg", 'white');
first.addProduct();
let second = new Product(2, 15000,'MacBook Pro 12', "Laptop.jpeg", 'white');
second.addProduct();
let third = new Product(3, 20000,'MacBook Pro 13', "Laptop.jpeg", 'white');
third.addProduct();
let fourth = new Product(4, 25000,'MacBook Pro 14', "Laptop.jpeg", 'white');
fourth.addProduct();
let fifth = new Product(5, 30000,'MacBook Pro 15', "Laptop.jpeg", 'white');
fifth.addProduct();
let sixth = new Product(6, 35000,'MacBook Pro 16', "Laptop.jpeg", 'white');
sixth.addProduct();
backgroundOdd();
...
let but3 = new Button("100px", "70px", "red", "Кнопочка");
but3 = but3.addProductButton();
cont.append(but3);
